...
class AddInjectNoise(TransformationPass):
    ...
    .. note::
        ...
        :class:`~.BoxKey` to ``prefix_ref``. This means that an instance of this pass asigns boxes
    ...
    def __init__(
        ...
        self._BOX_KEYS: dict[tuple[BoxKey, str], str] = {}
                ...
                if inject_noise_annotation := get_annotation(node.op, InjectNoise):
                    if (
                        ...
                        if self.overwrite is True:
                            ...
                            ref = self._BOX_KEYS[box_key, current_site]
                    ...
                    if (box_key, self.site) in self._BOX_KEYS:
                        ref = self._BOX_KEYS[box_key, self.site]
                    else:
                        ref = f"{self.prefix_ref}{str(hash(box_key))[:3]}"
                        self._BOX_KEYS[box_key, self.site] = ref
