...
class GroupMeasIntoBoxes(TransformationPass):
    ...
    .. note::
        Barriers, boxes, two-qubit gates, and resets act as delimiters. This means that when the
        pass encounters one of these on a subset of qubits, it immediately terminates the
        collection for those qubits and flushes the collected measurements into a box.
    """
