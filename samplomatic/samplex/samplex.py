...
class Samplex:
    ...
    as well as other array-valued fields to use in post-processing data collected from executing
    ...
    * :class:`~.CollectionNode`\s are responsible reading registers and writing to output values
    ...
    shows the simplest possible way to construct a samplex using the :func:`~.build`
