...
- Removed the `VirtualRegister.to_json_dict` method.
  Removed the `virtual_register_from_json` function. ([#223](https://github.com/Qiskit/samplomatic/issues/223))
